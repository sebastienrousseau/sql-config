...
This document describes how @sebastienrousseau/sql-config is run: who decides what, how
...
@sebastienrousseau/sql-config is **maintainer-led**. As of the current release line it has a single
