# `@sebastienrousseau/sql-config` Examples Catalog

This directory provides runnable, standalone examples covering **100% of the functionalities and features** provided by `@sebastienrousseau/sql-config`.
...
- [x] **.sqlfluff**: Standardized rule preset
- [x] **.sql-formatter.json**: Standardized rule preset
