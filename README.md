...
<p align="center">
  <img src="./sql-config.svg" alt="sql-config logo" width="128" />
</p>

<h1 align="center">@sebastienrousseau/sql-config</h1>
...
<p align="center">
  <a href="https://github.com/sebastienrousseau/sql-config/actions"><img src="https://img.shields.io/github/actions/workflow/status/sebastienrousseau/sql-config/ci.yml?branch=main&style=for-the-badge&logo=github" alt="Build Status" /></a>
  <a href="https://www.npmjs.com/package/@sebastienrousseau/sql-config"><img src="https://img.shields.io/npm/v/%40sebastienrousseau%2Fsql-config.svg?style=for-the-badge&color=fc8d62&logo=npm" alt="npm package" /></a>
  <a href="https://sebastienrousseau.com/sql-config/"><img src="https://img.shields.io/badge/docs-sebastienrousseau.com-brightgreen.svg?style=for-the-badge&logo=github" alt="Documentation" /></a>
  <a href="https://scorecard.dev/viewer/?uri=github.com/sebastienrousseau/sql-config"><img src="https://img.shields.io/ossf-scorecard/github.com/sebastienrousseau/sql-config?style=for-the-badge&label=OpenSSF%20Scorecard&logo=openssf" alt="OpenSSF Scorecard" /></a>
...
- [Dialect-Aware SQLFluff Linting & Formatting](#dialect-aware-sqlfluff-linting-formatting) — before and after rule comparison
...
# bun
bun add -d @sebastienrousseau/sql-config
```
...
cp node_modules/@sebastienrousseau/sql-config/.sql-formatter.json ./.sql-formatter.json
```

### Or point the tool at the installed file

```bash
sqlfluff lint --config node_modules/@sebastienrousseau/sql-config/.sqlfluff queries/
```
...
`@sebastienrousseau/sql-config` is a focused satellite of the [`@sebastienrousseau/config`](https://github.com/sebastienrousseau/config) suite — a unified ecosystem of single-purpose, zero-overhead developer configurations designed to share a single design philosophy, strict typing, and zero runtime dependencies.
...
### After (@sebastienrousseau/sql-config Enforced)
